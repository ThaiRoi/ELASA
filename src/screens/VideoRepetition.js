...
function VideoRepetition () {
    ...
    return (
        <View  style = {{flex: 1, backgroundColor: '#153C43'}}>
            ...
            <Text style = {styles.title}>VideoRepetition</Text>
            <Text style = {styles.titleView}>Today's watchlist:</Text>
            ...
            <FlatList
                    ...
                    return <Pressable
                        ...
                        <View style={{ height: 280, width: '90%', backgroundColor: '#234B76', margin: 10, borderRadius: 10, alignSelf: 'center' }}>
                            <Image
